...
origin_facenet_npy = os.path.join(settings.BASE_DIR, 'home/facenet_numpy')
origin_VGG16_npy = os.path.join(settings.BASE_DIR, 'home/vgg_feature_npy')
origin_mix_vgg_facenet_npy = os.path.join(
    settings.BASE_DIR, 'home/mix_vgg_facenet_numpy')
...
svm_model = os.path.join(
    settings.BASE_DIR, 'home/model/svm_face_final_model.sav')
...
voting_model = os.path.join(
    settings.BASE_DIR, 'home/model/voting_svm_NB_mlp_model.sav')
